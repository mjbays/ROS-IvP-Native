...
bool CMOOSApp::ConfigureComms()
{
	...
	{
	  //std::cout<<"\nm_CommandLineParser.GetVariable(--moos_host,m_sServerHost)";
	...
	{
	  //std::cout<<"\nm_CommandLineParser.GetVariable(--moos_port,m_lServerPort)";
    ...
    m_MissionReader.GetValue("COMMUNITY", communityName);
    
    m_Comms.Run(m_sServerHost.c_str(),m_lServerPort,m_sMOOSName.c_str(),communityName,m_nCommsFreq);
